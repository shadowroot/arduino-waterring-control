...
class Menu{
    public:
        Menu(const KeypadLCDControl& keypad, const Wattering& waterringState) : currentMenuItem(MenuItem::INITIAL), keypadLCDControl(keypad), waterringState(waterringState) {}
        void setup_hook();
        void loop_hook();
        void printMenu();
        void printMenuItem();
